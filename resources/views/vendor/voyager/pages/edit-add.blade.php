                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="category_pages_id">Loại tin tức</label>
                                <select class="form-control" name="category_pages_id">
                                    @foreach(App\Models\CategoryPage::all() as $category)
                                        <option value="{{ $category->id }}"@if(isset($dataTypeContent->category_pages_id) && $dataTypeContent->category_pages_id == $category->id) selected="selected"@endif>{{ $category->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
